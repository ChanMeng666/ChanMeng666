...
// ended ones. ArchCanvas (her own company) leads; She Sharp and GAVIGO both
// ended Sep 2026.
//
...
//     The two CURRENT ones (ArchCanvas, FemTech Weekend) lead;
//     She Sharp, GAVIGO, TechNest, Engram and Sanicle follow, ended but each carrying a
...
#set document(
  ...
  date: datetime(year: 2026, month: 9, day: 16),
