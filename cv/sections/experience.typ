...
#let experience() = section("Experience", {
  ...
  role-line(
    ...
    summary: [Recruited directly by founder Dr Mahsa Mohaghegh to rebuild New Zealand's leading women-in-STEM platform · *2,200+ active members, 8,000+ women supported lifetime* · *86.6% solo across 10 months* · Webflow → Next.js migration preserving 10+ years of legacy content with zero broken inbound links.],
  )
  role-line(
  ...
  block(above: 0pt, below: 0pt, {
    ...
    text(size: size-tiny, fill: muted, style: "italic")[
      *Previously:* Founding Junior Full-Stack Engineer at *Sanicle* — earned the company its *IBM Silver Partner* certification + PartnerPlus listing through a solo build (350+ commits, 180+ beta users, Nov 2023 — Nov 2024) · *ByteDance Backend & Full-Stack Engineer* on the Douyin Mall capstone — Spring Boot 3 backend + solo Vue 3 frontend, #2 of 8 contributors (Nov 2024 — Mar 2025) · Lincoln industry placement at *CORDE Christchurch* · *Forward With Her mentor* (360 mentors / 800 mentees · 7 of 18 LinkedIn recommendations from this cohort) · *CopilotKit* OSS contributor (2 merged PRs, 24.6k★).
    ]
  })
})
