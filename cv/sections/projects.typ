...
#let projects() = section("Selected Open-Source Projects", {
  let cards = (
    (
      ...
      context-line: [An AI financial-wellness app built around te ao Māori — the user's culture lives in the data model, not just the translation layer · an independent research commission from Riria (Missy) Te Kanawa personally (former KPMG NZ National Māori Sector lead; now Māori Executive Lead at ASB Bank, her employer).],
      bullets: (
